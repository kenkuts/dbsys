...
# Purchase.create(customer_id: 1, quantity: 3, price: 300, product_id:8) # NY
...
# Purchase.create(customer_id: 2, quantity: 1, price: 100, product_id:8) # NY
...
# Purchase.create(customer_id: 8, quantity: 1, price: 100, product_id: 8) # NY
# Purchase.create(customer_id: 8, quantity: 1, price: 100, product_id: 7)

# Purchase.create(customer_id: 7, quantity: 1, price: 100, product_id: 7) # PA
# Purchase.create(customer_id: 7, quantity: 1, price: 100, product_id: 8)

# Purchase.create(customer_id: 6, quantity: 1, price: 100, product_id: 8) # NY
# Purchase.create(customer_id: 6, quantity: 1, price: 100, product_id: 7)

# Purchase.create(customer_id: 9, quantity: 5, price: 500, product_id:7) # PA

# Purchase.create(customer_id: 4, quantity: 5, price: 500, product_id:7) # NJ
